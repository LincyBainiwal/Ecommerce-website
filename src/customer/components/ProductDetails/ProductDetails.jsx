...
import { Grid, Button, Rating, Box, LinearProgress } from '@mui/material'

import ProductReviewCard from './ProductReviewCard';
import { mensWearData } from '../cartSection/mensWearData';
import  MensCard from '../cartSection/MensCard'
      ...
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opactity-50 text-sm">
                    5650 Ratings
                  </p>
                  <p className="ml-3 text-sm font-medium text-pink-600 hover:text-pink-400">
                    300 Reviews
                  </p>
                </div>
              ...
              <form className="mt-10">
                ...
                <div className="py-8">
                  <Button  onClick={handleAddToCart} variant="contained" sx={{ px: "2rem", py: "1rem", bgcolor: "#f06292" }}>
                    Add to cart
                  </Button>
                </div>
              </form>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3 '>
                  ...
                  <p className='opacity-60'>5468 Ratings</p>
                </div>
                ...
                <Box className='mt-5 space-y-3'>
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} variant='determinate' value={25} className='bg-pink-600' />
                    </Grid>
                  </Grid>
                  <Grid container alignItems="center" gap={2}>
                    <Grid item xs={2}>
        ...
        <section>
          ...
          <div className="flex flex-wrap space-y-5">
            {mensWearData.map((item) =><MensCard product={item}/>)}
          </div>
        </section>
      </div>
    </div>
